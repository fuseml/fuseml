...
help:
	( echo _ _ ___ _____ ________ Overview ; fuseml help ; for cmd in apps completion create-org delete help info install orgs target uninstall ; do echo ; echo _ _ ___ _____ ________ Command $$cmd ; fuseml $$cmd --help ; done ; echo ) | tee HELP
